...
mach_royal_family = require "WALI/mach_royal_family"
...
function ReInitialise()
	return mach_royal_family.ReInitialise()
--  card_components = {}
...
function Initialise(info)
    return mach_royal_family.Initialise(info)
...
function SetupCard(location, id, card_data, selectable)
    return mach_royal_family.SetupCard(location, id, card_data, selectable)
...
function SelectHeir(card)
    return mach_royal_family.SelectHeir(card)
